...
\restrict OWbFtD6rjDCHJhOCK2y8V7QUpWcINqt8LKmlr01ualReT3NJqxdU6ZGG9t7t2va
...
--
-- Name: agencies; Type: TABLE; Schema: public; Owner: admin_user
--
...
ALTER TABLE public.agencies OWNER TO admin_user;
...
--
-- Name: ig_accounts; Type: TABLE; Schema: public; Owner: admin_user
--
...
CREATE TABLE public.ig_accounts (
    ...
    proxy_host character varying(255) DEFAULT ''::character varying,
    proxy_port integer,
    proxy_user character varying(255) DEFAULT ''::character varying,
    proxy_password character varying(255) DEFAULT ''::character varying,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE public.ig_accounts OWNER TO admin_user;

--
-- Name: interaction_campaigns; Type: TABLE; Schema: public; Owner: admin_user
--
...
CREATE TABLE public.interaction_campaigns (
    ...
    status character varying(50) DEFAULT 'ACTIVE'::character varying,
    ai_tone character varying(100),
    ai_user_prompt text,
    ollama_model character varying(100),
    comment_mode character varying(10) DEFAULT 'MANUAL'::character varying,
    manual_comments text,
    target_url text
);


ALTER TABLE public.interaction_campaigns OWNER TO admin_user;

--
-- Name: interaction_tasks; Type: TABLE; Schema: public; Owner: admin_user
--
...
ALTER TABLE public.interaction_tasks OWNER TO admin_user;

--
-- Data for Name: agencies; Type: TABLE DATA; Schema: public; Owner: admin_user
--

COPY public.agencies (id, name, is_active, created_at, plan_level) FROM stdin;
\.
...
29	Can add ig account	8	add_igaccount
30	Can change ig account	8	change_igaccount
31	Can delete ig account	8	delete_igaccount
32	Can view ig account	8	view_igaccount
33	Can add interaction campaign	9	add_interactioncampaign
34	Can change interaction campaign	9	change_interactioncampaign
35	Can delete interaction campaign	9	delete_interactioncampaign
36	Can view interaction campaign	9	view_interactioncampaign
37	Can add interaction task	10	add_interactiontask
38	Can change interaction task	10	change_interactiontask
39	Can delete interaction task	10	delete_interactiontask
40	Can view interaction task	10	view_interactiontask
\.
...
1	pbkdf2_sha256$1200000$FZx690uIJzTgK31KmPUBWW$VfBaSOo0+eDCvVZcGm0gO49vKwHxJhWSA/e8gcSO2Lk=	2026-01-08 06:16:51.313537+00	t	admin				t	t	2026-01-08 06:16:42.920155+00
\.
...
1	sessions	0001_initial	2026-01-08 06:11:30.656254+00
2	contenttypes	0001_initial	2026-01-08 06:13:01.341069+00
3	auth	0001_initial	2026-01-08 06:13:01.39532+00
4	admin	0001_initial	2026-01-08 06:13:01.410161+00
5	admin	0002_logentry_remove_auto_add	2026-01-08 06:13:01.415846+00
6	admin	0003_logentry_add_action_flag_choices	2026-01-08 06:13:01.421461+00
7	contenttypes	0002_remove_content_type_name	2026-01-08 06:13:01.432638+00
8	auth	0002_alter_permission_name_max_length	2026-01-08 06:13:01.438996+00
9	auth	0003_alter_user_email_max_length	2026-01-08 06:13:01.445161+00
10	auth	0004_alter_user_username_opts	2026-01-08 06:13:01.453898+00
11	auth	0005_alter_user_last_login_null	2026-01-08 06:13:01.460548+00
12	auth	0006_require_contenttypes_0002	2026-01-08 06:13:01.461868+00
13	auth	0007_alter_validators_add_error_messages	2026-01-08 06:13:01.468777+00
14	auth	0008_alter_user_username_max_length	2026-01-08 06:13:01.477194+00
15	auth	0009_alter_user_last_name_max_length	2026-01-08 06:13:01.485092+00
16	auth	0010_alter_group_name_max_length	2026-01-08 06:13:01.492995+00
17	auth	0011_update_proxy_permissions	2026-01-08 06:13:01.50023+00
18	auth	0012_alter_user_first_name_max_length	2026-01-08 06:13:01.508202+00
19	automation	0001_initial	2026-01-08 06:14:18.400356+00
20	automation	0002_interactioncampaign_ai_fields	2026-01-08 06:15:09.303015+00
21	automation	0003_alter_interactioncampaign_ai_persona_and_more	2026-01-08 06:16:24.202241+00
22	automation	0004_comment_mode_defaults	2026-01-08 06:16:24.203722+00
23	automation	0005_igaccount_proxy_fields	2026-01-08 06:16:24.204656+00
24	automation	0006_add_ai_provider_and_ollama_model	2026-01-08 06:16:24.205494+00
25	automation	0007_update_ai_provider_defaults	2026-01-08 06:16:24.206342+00
26	automation	0008_systemlog_alter_interactioncampaign_ai_provider_and_more	2026-01-08 06:16:24.207288+00
27	automation	0009_alter_igaccount_options	2026-01-08 06:16:24.208288+00
28	automation	0010_igaccount_agency_igaccount_session_id_and_more	2026-01-08 06:16:24.209399+00
29	automation	0011_add_cookies_to_igaccount	2026-01-08 06:16:24.210688+00
\.
...
qkn4gqvdvs0s15uilmewul3lt8hyymqy	.eJxVjEEOwiAQRe_C2hCmAi0u3fcMZIYZbNVAUtqV8e7apAvd_vfef6mI2zrFrckSZ1YXBer0uxGmh5Qd8B3LrepUy7rMpHdFH7TpsbI8r4f7dzBhm_a6I2YDQhLEUjK-NziEbHqwFpkpgw-YqAs9Zwck8LXOToY8eHDsnXp_ABCGOMA:1vdjKF:v2DENYIPT2Z7yXnKx99EZoyPTgY3AtyiWSAUGjMFuIM	2026-01-22 06:16:51.315545+00
\.


--
-- Data for Name: ig_accounts; Type: TABLE DATA; Schema: public; Owner: admin_user
--

COPY public.ig_accounts (id, agency_id, username, status, session_id, cookies, proxy_host, proxy_port, proxy_user, proxy_password, created_at) FROM stdin;
\.


--
-- Data for Name: interaction_campaigns; Type: TABLE DATA; Schema: public; Owner: admin_user
--

COPY public.interaction_campaigns (id, name, agency_id, is_active, ai_provider, ai_persona, created_at, action, ai_model, ai_temperature, ai_max_tokens, status, ai_tone, ai_user_prompt, ollama_model, comment_mode, manual_comments, target_url) FROM stdin;
\.


--
-- Data for Name: interaction_tasks; Type: TABLE DATA; Schema: public; Owner: admin_user
--

COPY public.interaction_tasks (id, campaign_id, ig_account_id, status, created_at, agency_id) FROM stdin;
\.
...
--
-- Name: agencies agencies_pkey; Type: CONSTRAINT; Schema: public; Owner: admin_user
--
...
--
-- Name: ig_accounts ig_accounts_pkey; Type: CONSTRAINT; Schema: public; Owner: admin_user
--
...
--
-- Name: interaction_campaigns interaction_campaigns_pkey; Type: CONSTRAINT; Schema: public; Owner: admin_user
--
...
--
-- Name: interaction_tasks interaction_tasks_pkey; Type: CONSTRAINT; Schema: public; Owner: admin_user
--
...
--
-- Name: interaction_tasks_agency_id_idx; Type: INDEX; Schema: public; Owner: admin_user
--

CREATE INDEX interaction_tasks_agency_id_idx ON public.interaction_tasks USING btree (agency_id);
...
--
-- Name: ig_accounts ig_accounts_agency_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin_user
--

ALTER TABLE ONLY public.ig_accounts
    ADD CONSTRAINT ig_accounts_agency_id_fkey FOREIGN KEY (agency_id) REFERENCES public.agencies(id) ON DELETE SET NULL;


--
-- Name: interaction_campaigns interaction_campaigns_agency_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin_user
--

ALTER TABLE ONLY public.interaction_campaigns
    ADD CONSTRAINT interaction_campaigns_agency_id_fkey FOREIGN KEY (agency_id) REFERENCES public.agencies(id) ON DELETE SET NULL;


--
-- Name: interaction_tasks interaction_tasks_agency_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin_user
--

ALTER TABLE ONLY public.interaction_tasks
    ADD CONSTRAINT interaction_tasks_agency_id_fkey FOREIGN KEY (agency_id) REFERENCES public.agencies(id) ON DELETE SET NULL;


--
-- Name: interaction_tasks interaction_tasks_campaign_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin_user
--

ALTER TABLE ONLY public.interaction_tasks
    ADD CONSTRAINT interaction_tasks_campaign_id_fkey FOREIGN KEY (campaign_id) REFERENCES public.interaction_campaigns(id) ON DELETE CASCADE;


--
-- Name: interaction_tasks interaction_tasks_ig_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin_user
--

ALTER TABLE ONLY public.interaction_tasks
    ADD CONSTRAINT interaction_tasks_ig_account_id_fkey FOREIGN KEY (ig_account_id) REFERENCES public.ig_accounts(id) ON DELETE CASCADE;
...
\unrestrict OWbFtD6rjDCHJhOCK2y8V7QUpWcINqt8LKmlr01ualReT3NJqxdU6ZGG9t7t2va
